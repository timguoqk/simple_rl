...
def main(open_plot=True):
    ...
    abstr_identity_agent = AbstractionWrapper(QLearnerAgent, actions=mdp.get_actions())

    # Run experiment and make plot.
    run_agents_on_mdp([ql_agent, rand_agent, abstr_identity_agent], mdp, instances=5, episodes=100, steps=150,
                      open_plot=open_plot)
